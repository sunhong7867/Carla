...
print(f"[DEBUG][S1] time={self.current_time_ms:.1f}ms | EstimatedVelocity = {ego_data.velocity_x:.2f} m/s, Target = 15.00 m/s, Error = {speed_error_target:.2f} m/s → {'OK' if speed_error_target <= 1.0 else 'FAIL'}")
